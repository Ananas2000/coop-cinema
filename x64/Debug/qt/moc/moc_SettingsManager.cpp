...
template <> constexpr inline auto SettingsManager::qt_create_metaobjectdata<qt_meta_tag_ZN15SettingsManagerE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "settingChanged",
        "",
        "SettingsManager::SettingsCategory",
        "category",
        "key",
        "QVariant",
        "value",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(SettingsManager::SettingsCategory, const QString &, const QVariant &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        QtMocHelpers::EnumData<SettingsCategory>(12, 12, QMC::EnumFlags{}).add({
            {   13, SettingsCategory::NETWORK },
            {   14, SettingsCategory::PLAYBACK },
            {   15, SettingsCategory::UI },
            {   16, SettingsCategory::PROFILE },
        }),
    };
...
void SettingsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->settingChanged((*reinterpret_cast< std::add_pointer_t<SettingsManager::SettingsCategory>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QVariant>>(_a[3]))); break;
        case 1: _t->profileLoaded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(SettingsManager::SettingsCategory , const QString & , const QVariant & )>(_a, &SettingsManager::settingChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)(const QString & )>(_a, &SettingsManager::profileLoaded, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SettingsManager::*)()>(_a, &SettingsManager::settingsReset, 2))
            return;
    }
}
...
// SIGNAL 0
void SettingsManager::settingChanged(SettingsManager::SettingsCategory _t1, const QString & _t2, const QVariant & _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2, _t3);
}

// SIGNAL 1
void SettingsManager::profileLoaded(const QString & _t1)
{
